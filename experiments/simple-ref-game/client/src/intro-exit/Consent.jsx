      ...
      <div className="w-1/2 mt-3 sm:mt-5 p-20">
        ...
        <div className="instructions">
          ...
          <p>
            ...
            games with other participants: describing shapes back and forth to earn points.
          </p> <br/>
          <p>
            <strong>Time required:</strong> This study will take approximately twenty minutes.
          </p><br/>
          <p>
            <strong>Purpose of the research:</strong> The purpose is to understand how language changes over time when used in groups.
          </p><br/>
          <p>
