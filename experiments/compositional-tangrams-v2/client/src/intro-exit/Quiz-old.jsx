...
export function Quiz({next, previous}) {
  //const game = useGame();
          ...
          <div className="flex justify-between">
              <Button 
                  handleClick={(e) => {
                    ...
                    e.preventDefault();
                    console.log("Current answers before clearing:", answers);
                    setAnswers({});
                    console.log("Answers cleared");
                    if (previous) {
                      console.log("Previous function exists, calling it now");
                      previous();
                      console.log("Previous function called");
                    } else {
                      console.log("WARNING: Previous function is undefined!");
                    }
                  }}
                  primary
                >
